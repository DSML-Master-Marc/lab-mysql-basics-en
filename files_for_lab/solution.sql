...
/* Query 10 - In the order table, which account_ids were responsible for orders between order_id 29540 and order_id 29560*/
...
SELECT type, COUNT(*) AS total_type_cards
FROM card
GROUP BY type
ORDER BY total_type_cards DESC;
